...
fun part2(input: String) {
    ...
    while(toVisit.isNotEmpty()) {
        ...
        // perimeter = perimetersCol.values.flatten().size + perimetersRow.values.flatten().size
